                    ...
                    <div className="relative bg-white rounded-lg w-full max-w-4xl mx-auto shadow-xl">
                        <div className="relative p-6">
                            ...
                            <div className="absolute -top-48 -left-48 w-160 h-160 flex items-center justify-center">
                                <img alt='QuestionEgg' src={`${process.env.PUBLIC_URL}/QuestionEgg.gif`} className="md:w-128 md:h-128" />
                            </div>
                        ...
                        <div className="md:w-1/2 basis-1/2">
                            ...
                            >
                                <div className="transform hover:scale-105 transition-transform duration-300 max-w-72">
                                    <img
                                        src={`${process.env.PUBLIC_URL}/TeamLeader.jpg`}
                                        alt={`Leader`}
                    ...
                    <AnimatedSection animation="fade" delay={0.2}>
                        <div className="container mx-auto px-4 text-center relative z-10">
                            <div className="max-w-3xl mx-auto">
                                <img
                                    src={`${process.env.PUBLIC_URL}/OriginalEgg.gif`}
...
// English version placeholder - using same component for now
export const HomePageEN = HomePageZH;
